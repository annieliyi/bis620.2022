...
get_diag(full_data, "SUBJID", "DIAGTYPE", "ATRT")[[1]] %>%
  head(10) %>%
  kable()#the first 10 rows of the counts of diagnosis types
#without stages are shown below
...
```{r, fig.align='center', fig.dim = c(10, 3)}
get_response(full_data, "SUBJID", "ATRT", "RSRESP",
             "RSCONFYN", "DIAGTYPE")[[1]] %>% kable()
